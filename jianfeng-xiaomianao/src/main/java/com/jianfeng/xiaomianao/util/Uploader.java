...
public class Uploader {
    ...
    // ${gamepro.release.filepath}")
    private String baseUrl = "/home/appusr/";
    ...
    // 保存路径
    private String savePath = "/xiaomianaoImg/images";

    // 文件允许格式
    private String[] allowFiles = { ".rar", ".doc", ".docx", ".zip", ".pdf", ".txt", ".swf", ".wmv", ".gif", ".png", ".jpg",
            ".jpeg", ".bmp" };
    ...
    public void upload() throws Exception {
        ...
        logger.info("保存图片路径：" + savePath);
        dff.setRepository(new File(savePath));
        try {
            ServletFileUpload sfu = new ServletFileUpload(dff);
            logger.info("上传图片路径：" + sfu);
