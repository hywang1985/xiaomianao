...
@Service("handler_601")
public class FavoriteNewsHandler extends AbstractHandler {
    ...
    public Object processInPractice(ClientRequest clientRequest,Object... params) throws Exception {
        ...
        logger.info("handler_601 收藏资讯-用户id:{} ,资讯id:{}", new String[] { userId, newsIds.toString()});
        return favoriteService.favoriteNews(userId, newsIds).getUserid();
    }
