...
@Service("handler_505")
public class SubscribeCommunityHandler extends AbstractHandler {
    ...
    public Object processInPractice(ClientRequest clientRequest,Object... params) throws Exception {
        ...
        logger.info("handler_505 订阅社区ids:{}", communityIds.toArray().toString());
        return subService.subscribeCommunities(userId, communityIds).getUserid();
    }
}
