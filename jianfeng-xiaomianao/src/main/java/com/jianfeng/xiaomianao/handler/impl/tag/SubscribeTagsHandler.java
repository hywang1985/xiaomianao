...
@Service("handler_501")
public class SubscribeTagsHandler extends AbstractHandler {
    ...
    public Object processInPractice(ClientRequest clientRequest,Object... params) throws Exception {
        ...
        logger.info("handler_501 订阅标签 tags:{}", tags.toArray());
        return subService.subscribeTags(userId, tags).getUserid();
    }
